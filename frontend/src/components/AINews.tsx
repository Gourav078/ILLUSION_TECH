...
//           loop
//           autoplay
//           style={{ width: "750px", height: "600px", marginTop: "30px" }} // Added margin to make space for popup
//         />

//         {/* Popup Message - Positioned above robot */}
//         <div className="absolute left-10 top-10 ml-4 mt-2 bg-black bg-opacity-90 border-green-400 rounded-lg p-3 w-62 terminal-popup">
//           <div className="flex">
//             <div className="mr-2">
...
//                 WELCOME TO <br /> ILLUSION SECURITY
//               </h2>
