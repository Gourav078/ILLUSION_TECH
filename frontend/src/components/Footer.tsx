...
const Footer = () => {
  return (
    <footer
      className="backdrop-blur-md  border-t border-cyber-accent/20 main-font-family"
      style={
        {
      ...
      >
        ...
        <div className="flex justify-between flex-col md:flex-row  items-center md:items-start  md:gap-[5rem] text-left">
          ...
          <div className="flex flex-col w-full md:w-1/2 md:p-0 py-4 gap-4 text-center md:text-left">
            ...
            {/* <svg
              className="text-[1rem] w-full lg:w-1/2 sm:text-[1rem] md:text-[1.75rem] lg:text-[1.90rem]"
              style={{
                // width: "50%",
                height: "auto",
              }}
            ...
            >
              <defs>
                <linearGradient id="gradient">
                  <stop stopColor="#a9abaa" offset="0"></stop>
                  <stop stopColor="#a9abaa" offset="1"></stop>
                </linearGradient>
              </defs>
              <g
          ...
          <div className="flex flex-col gap-4 relative text-center md:text-left">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Link
                      ...
                      className="hover:scale-110 transition-transform text-cyber-accent hover:text-gray-400 text-[#646464]"
                    >
            ...
            {/* <div className="flex flex-col gap-4 relative">
              ...
              >
                <p className="text-[22px] font-bold footer-main text-[#646464]">
                  Contact Us
                </p>
              </Link>
              <span className="top-[33px] absolute w-[7rem] h-[4px] bg-[#3c4d8b]"></span>
