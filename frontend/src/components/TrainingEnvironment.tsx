      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="mb-16 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Join our intensive 3-4 hour workshop where we dive deep into the world of cybersecurity and AI. 
            Understand the industry demands, career paths, and essential skills needed to succeed in these 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-cyber-secondary mb-2">1-on-1 Mentorship</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-cyber-secondary mb-2">Real-World Examples</h3>
            <p className="text-gray-300">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-cyber-secondary mb-2">Hands-on Learning</h3>
            <p className="text-gray-300">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-cyber-secondary mb-2">Flexible Schedule</h3>
            <p className="text-gray-300">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-cyber-secondary mb-2">Industry Skills</h3>
            <p className="text-gray-300">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-cyber-secondary mb-2">Career Guidance</h3>
            <p className="text-gray-300">
